...
|Req|Detalle|
|:-|:-|
|CRUD simple|1. CRUD Tono<br>2. CRUD Servicio<br>3. CRUD Marca<br>4. CRUD Categoria|
|CRUD dependiente|1. CRUD Producto {depende de} CRUD Categoria<br>2. CRUD Formula {depende de} CRUD Tono y CRUD Producto|
...
|Req|Detalle|
|:-|:-|
|CRUD |1. CRUD Tono<br>2. CRUD Servicio<br>3. CRUD Marca<br>4. CRUD Persona<br>5. CRUD Categoria<br>6. CRUD Descuento<br>7. CRUD Producto<br>8. CRUD Atencion<br>9. CRUD Turno<br>10. CRUD Formula|
